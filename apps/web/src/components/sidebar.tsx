...
export function Sidebar() {
  ...
  return (
    <aside className="hidden w-60 shrink-0 flex-col border-r border-border bg-card/50 p-4 lg:flex">
      ...
      <button className="mt-4 flex h-11 items-center justify-center gap-2 rounded-xl bg-primary px-4 text-sm font-medium text-primary-foreground transition hover:opacity-90 active:scale-[0.98]">
